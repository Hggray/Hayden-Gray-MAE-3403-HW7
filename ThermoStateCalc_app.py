#region imports
import sys
from ThermoStateCalc1 import Ui__frm_StateCalculator
...
class main_window(QWidget,Ui__frm_StateCalculator):
    ...
    def setUnits(self):
        Property1Value_State1 = 0.0
        Property2Value_State1 = 0.0
        Property1Value_State2 = 0.0
        Property2Value_State2 = 0.0
        """
        ...
        # Check for empty strings and convert text to float or set to 0.0 if empty
        ...
        SpecifiedProperty1_State1 = self._cmb_State1_Property1.currentText()
        SpecifiedProperty2_State1 = self._cmb_State1_Property2.currentText()
        Property1Value_State1 = safe_float_convert(self._le_State1_Property1.text())
        Property2Value_State1 = safe_float_convert(self._le_State1_Property2.text())

        SpecifiedProperty1_State2 = self._cmb_State2_Property1.currentText()
        SpecifiedProperty2_State2 = self._cmb_State2_Property2.currentText()
        Property1Value_State2 = safe_float_convert(self._le_State2_Property1.text())
        Property2Value_State1 = safe_float_convert(self._le_State2_Property2.text())

        #read numerical values for selected properties
        self._lbl_State1_Property1_Units.setText(
            self.p_Units if 'Pressure' in SpecifiedProperty1_State1 else self.t_Units if 'Temperature' in SpecifiedProperty1_State1 else self.u_Units if 'Energy' in SpecifiedProperty1_State1 else self.h_Units if 'Enthalpy' in SpecifiedProperty1_State1 else self.s_Units if 'Entropy' in SpecifiedProperty1_State1 else self.v_Units if 'Volume' in SpecifiedProperty1_State1 else "")
        self._lbl_State1_Property2_Units.setText(
            self.p_Units if 'Pressure' in SpecifiedProperty2_State1 else self.t_Units if 'Temperature' in SpecifiedProperty2_State1 else self.u_Units if 'Energy' in SpecifiedProperty2_State1 else self.h_Units if 'Enthalpy' in SpecifiedProperty2_State1 else self.s_Units if 'Entropy' in SpecifiedProperty2_State1 else self.v_Units if 'Volume' in SpecifiedProperty2_State1 else "")

        #set units labels and convert values if needed
        if 'Pressure' in SpecifiedProperty1_State1 and UnitChange:
            Property1Value_State1 *= UC.psi_to_bar if SI else UC.bar_to_psi
        elif 'Temperature' in SpecifiedProperty1_State1 and UnitChange:
            Property1Value_State1 = UC.F_to_C(Property1Value_State1) if SI else UC.C_to_F(Property1Value_State1)
        elif 'Energy' in SpecifiedProperty1_State1 and UnitChange:
            Property1Value_State1 *= UC.btuperlb_to_kJperkg if SI else UC.kJperkg_to_btuperlb
        elif 'Enthalpy' in SpecifiedProperty1_State1 and UnitChange:
            Property1Value_State1 *= UC.btuperlb_to_kJperkg if SI else UC.kJperkg_to_btuperlb
        elif 'Entropy' in SpecifiedProperty1_State1 and UnitChange:
            Property1Value_State1 *= UC.btuperlbF_to_kJperkgC if SI else UC.kJperkgC_to_btuperlbF
        elif 'Volume' in SpecifiedProperty1_State1 and UnitChange:
            Property1Value_State1 *= UC.ft3perlb_to_m3perkg if SI else UC.m3perkg_to_ft3perlb

        if 'Pressure' in SpecifiedProperty2_State1 and UnitChange:
            Property2Value_State1 *= UC.psi_to_bar if SI else UC.bar_to_psi
        elif 'Temperature' in SpecifiedProperty2_State1 and UnitChange:
            Property2Value_State1 = UC.F_to_C(Property2Value_State1) if SI else UC.C_to_F(Property2Value_State1)
        elif 'Energy' in SpecifiedProperty2_State1 and UnitChange:
            Property2Value_State1 *= UC.btuperlb_to_kJperkg if SI else UC.kJperkg_to_btuperlb
        elif 'Enthalpy' in SpecifiedProperty2_State1 and UnitChange:
            Property2Value_State1 *= UC.btuperlb_to_kJperkg if SI else UC.kJperkg_to_btuperlb
        elif 'Entropy' in SpecifiedProperty2_State1 and UnitChange:
            Property2Value_State1 *= UC.btuperlbF_to_kJperkgC if SI else UC.kJperkgC_to_btuperlbF
        elif 'Volume' in SpecifiedProperty2_State1 and UnitChange:
            Property2Value_State1 *= UC.ft3perlb_to_m3perkg if SI else UC.m3perkg_to_ft3perlb

        self._lbl_State2_Property1_Units.setText(
            self.p_Units if 'Pressure' in SpecifiedProperty1_State2 else self.t_Units if 'Temperature' in SpecifiedProperty1_State2 else self.u_Units if 'Energy' in SpecifiedProperty1_State2 else self.h_Units if 'Enthalpy' in SpecifiedProperty1_State2 else self.s_Units if 'Entropy' in SpecifiedProperty1_State2 else self.v_Units if 'Volume' in SpecifiedProperty1_State2 else "")
        self._lbl_State2_Property2_Units.setText(
            self.p_Units if 'Pressure' in SpecifiedProperty2_State2 else self.t_Units if 'Temperature' in SpecifiedProperty2_State2 else self.u_Units if 'Energy' in SpecifiedProperty2_State2 else self.h_Units if 'Enthalpy' in SpecifiedProperty2_State2 else self.s_Units if 'Entropy' in SpecifiedProperty2_State2 else self.v_Units if 'Volume' in SpecifiedProperty2_State2 else "")

        if 'Pressure' in SpecifiedProperty1_State2 and UnitChange:
            Property1Value_State2 *= UC.psi_to_bar if SI else UC.bar_to_psi
        elif 'Temperature' in SpecifiedProperty1_State2 and UnitChange:
            Property1Value_State2 = UC.F_to_C(Property1Value_State2) if SI else UC.C_to_F(Property1Value_State2)
        elif 'Energy' in SpecifiedProperty1_State2 and UnitChange:
            Property1Value_State2 *= UC.btuperlb_to_kJperkg if SI else UC.kJperkg_to_btuperlb
        elif 'Enthalpy' in SpecifiedProperty1_State2 and UnitChange:
            Property1Value_State2 *= UC.btuperlb_to_kJperkg if SI else UC.kJperkg_to_btuperlb
        elif 'Entropy' in SpecifiedProperty1_State2 and UnitChange:
            Property1Value_State2 *= UC.btuperlbF_to_kJperkgC if SI else UC.kJperkgC_to_btuperlbF
        elif 'Volume' in SpecifiedProperty1_State2 and UnitChange:
            Property1Value_State2 *= UC.ft3perlb_to_m3perkg if SI else UC.m3perkg_to_ft3perlb

        if 'Pressure' in SpecifiedProperty2_State2 and UnitChange:
            Property2Value_State2 *= UC.psi_to_bar if SI else UC.bar_to_psi
        elif 'Temperature' in SpecifiedProperty2_State2 and UnitChange:
            Property2Value_State2 = UC.F_to_C(Property2Value_State2) if SI else UC.C_to_F(Property2Value_State2)
        elif 'Energy' in SpecifiedProperty2_State2 and UnitChange:
            Property2Value_State2 *= UC.btuperlb_to_kJperkg if SI else UC.kJperkg_to_btuperlb
        elif 'Enthalpy' in SpecifiedProperty2_State2 and UnitChange:
            Property2Value_State2 *= UC.btuperlb_to_kJperkg if SI else UC.kJperkg_to_btuperlb
        elif 'Entropy' in SpecifiedProperty2_State2 and UnitChange:
            Property2Value_State2 *= UC.btuperlbF_to_kJperkgC if SI else UC.kJperkgC_to_btuperlbF
        elif 'Volume' in SpecifiedProperty2_State2 and UnitChange:
            Property2Value_State2 *= UC.ft3perlb_to_m3perkg if SI else UC.m3perkg_to_ft3perlb

        self._le_State1_Property1.setText("{:0.3f}".format(Property1Value_State1))
        self._le_State1_Property2.setText("{:0.3f}".format(Property2Value_State1))
        self._le_State2_Property1.setText("{:0.3f}".format(Property1Value_State2))
        self._le_State2_Property2.setText("{:0.3f}".format(Property2Value_State2))
